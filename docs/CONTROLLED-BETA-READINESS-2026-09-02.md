...
Candidate commit: `0e5465b8ea50f949742cd3bb706015d2b3859874`

Qualified local image: `sha256:768fada3f895520f2752843df229ddc38aa43772377bdce63097b76eb70e6e80`
...
|---|---|---|
| Reproducible and maintainable application | `.github/workflows/quality.yml` defines a SHA-pinned two-leg gate. `deploy/qualified-images.env` pins six multi-platform dependencies. `npm run test:production-image` built the source-labelled candidate and passed 95 real Forgejo/PostgreSQL/S3 journey assertions plus a 54-check fresh-service restore. The strict clean-tree `launch-gate.sh` completed, and the production dependency audit reports zero vulnerabilities. | **Software PASS; operating evidence missing.** The candidate and this audit remain local, so hosted CI has not run them and no registry digest has been promoted. |
...
```text
PRODUCTION IMAGE QUALIFIED — sha256:768fada3f895520f2752843df229ddc38aa43772377bdce63097b76eb70e6e80 records 0e5465b8ea50f949742cd3bb706015d2b3859874 and reproduced the frozen release after restore.
```
