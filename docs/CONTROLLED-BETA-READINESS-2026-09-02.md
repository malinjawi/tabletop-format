...
Candidate commit: `e98104ef1795200e4d85ee11d7027a2aeac18588`

Qualified local image: `sha256:f13b5bf194e166f59fb453f433abbad01462376b90167a81f59d858b653b2ca4`
...
- 56 Store-2 contracts on SQLite and the same 56 on digest-pinned PostgreSQL 16,
  including atomic single-use invite redemption and password recovery, expiry,
  revocation, replay rejection, full session invalidation, and a simultaneous
  invitation-redemption race;
- one real narrow-browser account-access flow proving invitation registration,
  credential clearing, assisted recovery, old-session invalidation, new-password
  login, and one-use token rejection;
...
```text
PRODUCTION IMAGE QUALIFIED — sha256:f13b5bf194e166f59fb453f433abbad01462376b90167a81f59d858b653b2ca4 records e98104ef1795200e4d85ee11d7027a2aeac18588 and reproduced the frozen release after restore.
```
