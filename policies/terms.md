...
Do not upload unlawful, infringing, malicious, deceptive, or privacy-invasive material. Do not bypass access controls, rate limits, review rules, release checks, or jam rules. A project marked private is not a substitute for permission to possess its contents.

Forking and remixing are allowed only when the displayed license or documented permission allows them. Trademarks and community identity can have restrictions separate from copyright licenses.
