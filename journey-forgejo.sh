...
if [ -n "${FORGE_EXISTING_GATEWAY_URL:-}" ]; then
  journey_command=(env FORGE_URL="$FORGE_URL" FORGE_TOKEN="$FORGE_TOKEN"
    ...
    FORGE_JOURNEY_INVITE_ALICE="${FORGE_JOURNEY_INVITE_ALICE:-}"
    FORGE_JOURNEY_INVITE_BOB="${FORGE_JOURNEY_INVITE_BOB:-}"
    FORGE_JOURNEY_INVITE_CHARLIE="${FORGE_JOURNEY_INVITE_CHARLIE:-}"
