...
function layoutFor(starter) {
  ...
  const hasCost = starter.fields.includes("cost"), hasPower = starter.fields.includes("power");
  ...
  if (starter.template === "minimal") {
    regions = [
      { id: "title", type: "text", src: "card.name", x: 5, y: 6, w: W - 10, h: 9, font: "title", size_pt: 13, align: "left", valign: "middle", color: "#111827" },
      ...
      { id: "type", type: "text", src: "card.type", x: 5, y: H - 8, w: W - 10, h: 4, font: "title", size_pt: 6.5, align: "left", valign: "middle", uppercase: true, color: "#6b7280" },
    ];
  } else if (starter.template === "party") {
    regions = [
      { id: "shell", type: "rect", x: 0, y: 0, w: W, h: H, fill: "#171923", radius_mm: 3 },
      { id: "rules", type: "richtext", src: "card.text", x: 6, y: 9, w: W - 12, h: H - 24, font: "title", size_pt: 16, min_size_pt: 9, align: "left", color: "#ffffff", symbols: true, autoshrink: true },
      { id: "title", type: "text", src: "card.name", x: 6, y: H - 12, w: W - 12, h: 6, font: "title", size_pt: 8, align: "left", valign: "middle", color: "#c4b5fd" },
    ];
  } else {
    regions = [
      ...
      { id: "type", type: "text", src: "card.type", x: 6, y: 18 + H * .38, w: W - 12, h: 5, font: "title", size_pt: 7, align: "left", valign: "middle", uppercase: true, color: "#334155" },
...
export function buildCardStarter(game, raw) {
  ...
  const files = [
    ...
    { path: "templates/layout.yaml", content: yaml.dump(layoutFor(starter), { noRefs: true, lineWidth: -1, sortKeys: false }) },
  ...
  return { starter, game: nextGame, cards, printings, layout: layoutFor(starter), files };
}
